...
public class UserEntityController implements Serializable {
    ...
    @EJB
    private beans.UserEntityFacade ejbFacade;
    ...
    public String create() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/Bundle").getString("UserEntityCreated"));
    ...
    public String update() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/Bundle").getString("UserEntityUpdated"));
            return "View";
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/Bundle").getString("PersistenceErrorOccured"));
            return null;
    ...
    private void performDestroy() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/Bundle").getString("UserEntityDeleted"));
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/Bundle").getString("PersistenceErrorOccured"));
        }
    }
    ...
    public UserEntity getUserEntity(java.lang.Long id) {
        return ejbFacade.find(id);
    }

    private Boolean validate(String email, String password) {
        Boolean logged = false;
        List<UserEntity> users = ejbFacade.findAll();
    ...
    public static class UserEntityControllerConverter implements Converter {
        ...
        public Object getAsObject(FacesContext facesContext, UIComponent component, String value) {
            ...
            return controller.getUserEntity(getKey(value));
        }
    ...
    public void login() {
        Boolean logged = validate(current.getEmail(),current.getPassword());
        System.out.println("########################## " + logged + "###############################");
        if (logged && current.getIsAdmin()==true) {
            goToAdmin();
        }else if (logged) {
            goToUser();
        }
        else{
           System.out.println("########################## your credentials do not match our records ###############################");
        }
    ...
    public void register() {
        ...
        System.out.println("User " + current.getAdresse()+ " has been created successfully");
    }
    public void search(){
